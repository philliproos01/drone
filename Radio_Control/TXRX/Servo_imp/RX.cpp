...
void setup() {
  ...
  sideTiltServo.attach(14);
  sideTiltServo.write(90);
...
void loop() {
  ...
  int dataCount = parseData(str.c_str(), dataArray, 10);
  Serial.print("Parsed ");
  Serial.print(dataCount);
  Serial.println(" values:");
  
  //TODO: test servo functionality

  /* THIS IS HOW IT IS DONE WITH JUST ONE at a time
  if(ID == 0x6)
    {
      sideTiltServo.write(data);
    }
    else if(ID == 0x7)
    {
